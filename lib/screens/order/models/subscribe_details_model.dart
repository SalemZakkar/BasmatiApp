...
class SubscribeDetailsModel {
  SubscribeDetailsModel({
    SubscribeDetailsData? data,
  }) {
    _data = data;
  }

  SubscribeDetailsModel.fromJson(dynamic json) {
    _data = json['data'] != null
        ? SubscribeDetailsData.fromJson(json['data'])
        : null;
  }
  SubscribeDetailsData? _data;
  SubscribeDetailsModel copyWith({
    SubscribeDetailsData? data,
  }) =>
      SubscribeDetailsModel(
        data: data ?? _data,
      );
  SubscribeDetailsData? get data => _data;
...
class SubscribeDetailsData {
  SubscribeDetailsData({
    String? id,
    String? type,
  ...
  SubscribeDetailsData.fromJson(dynamic json) {
    _id = json['id'];
    _type = json['type'];
